...
namespace WebForum.Controllers
{
    public class CommentsController : Controller
    {
        ...
        {
            var webForumContext = _context.Comment.Include(c => c.Discussion);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CommentId,Title,Content,CreateDate,DiscussionId")] Comment comment)
        {
